<template>
  <div class="container mx-auto flex justify-center items-center h-screen">
    <div class="card border border-gray-300 rounded-lg bg-white shadow-md">
      <h1 class="card-header text-xl text-white font-bold bg-blue-800 py-2 px-4 rounded-t-lg">Product Profile</h1>
      <div class="card-body">
        <div v-if="showEdit">
          <form @submit.prevent="submit">
            ...
            <button type="submit" class="btn bg-blue-800 text-white py-2 px-6 rounded">Save</button>
          </form>
        </div>
        ...
        <div class="col-12 flex justify-center mt-6">
          <button onclick="window.history.back()" class="btn bg-blue-800 text-white py-2 px-6 rounded">Back</button>
          <button class="btn bg-blue-800 text-white py-2 px-6 rounded ml-4" @click="toggleEdit">{{ showEdit ? 'Cancel' : 'Edit' }}</button>
          <button class="btn bg-blue-800 text-white py-2 px-6 rounded ml-4" @click="delProduct">Delete</button>
        </div>
      </div>
    </div>
  </div>
